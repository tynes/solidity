...
{
	m_transientStateVariables[&_declaration] = make_pair(_storageOffset, _byteOffset);
}
...
pair<u256, unsigned> CompilerContext::storageLocationOfTransientVariable(Declaration const& _declaration) const
{
